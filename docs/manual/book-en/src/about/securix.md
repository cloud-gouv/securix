...
Sécurix is mainly distributed under the [MIT](https://github.com/cloud-gouv/securix/blob/main/LICENSES/MIT.txt) license. See the `LICENSES` folder for more details. The project makes use of [REUSE](https://reuse.software/) to annotate the licenses.
