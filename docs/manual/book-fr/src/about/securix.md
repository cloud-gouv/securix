...
Sécurix est distribué en majeure partie sous licence [MIT](https://github.com/cloud-gouv/securix/blob/main/LICENSES/MIT.txt). Voir le dossier `LICENSES` pour plus de détails. Le projet utilise [REUSE](https://reuse.software/) pour annoter les licences utilisés.
