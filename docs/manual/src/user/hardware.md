...
> [!WARNING]
> Currently, the team doesn't accept hardware contributions from the community because they could not be validated by the project team.

However, if your hardware is not supported, you could still use it in SecurixOS by creating and importing your own module in your configuration. A SecurixOS hardware module file `your-hardware.nix` looks like:
